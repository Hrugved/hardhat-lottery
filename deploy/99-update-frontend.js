...
const FRONTEND_ADDRESSES_FILE = path.resolve(__dirname, '../app/constants/contractAddresses.json')
const FRONTEND_ABI_FILE = path.resolve(__dirname, '../app/constants/abi.json')
